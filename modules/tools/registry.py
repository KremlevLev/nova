# --- БАЗОВЫЕ ИНСТРУМЕНТЫ (ОС, Текст, Время, Звук, Веб) ---
...
# --- НОВЫЕ ИНСТРУМЕНТЫ (Для новых категорий роутера) ---
manage_media_tool = {
    "type": "function", "function": {
        "name": "manage_media", 
        "description": "Управление музыкой и видео.", 
        "parameters": {"type": "object", "properties": {"action": {"type": "string", "description": "'play_pause', 'next', 'prev'"}}, "required": ["action"]}}}

manage_windows_tool = {
    "type": "function", "function": {
        "name": "manage_windows", 
        "description": "Управление окнами Windows.", 
        "parameters": {"type": "object", "properties": {"action": {"type": "string", "description": "'minimize_all' (свернуть все) или 'close_current' (закрыть активное)"}}, "required": ["action"]}}}

create_note_tool = {
    "type": "function", "function": {
        "name": "create_quick_note", 
        "description": "Сохраняет текст/идею/напоминание в текстовый файл на рабочем столе.", 
...
set_timer_tool = {
    "type": "function", "function": {
        ...
        "parameters": {"type": "object", "properties": {"minutes": {"type": "integer", "description": "Количество минут"}}, "required": ["minutes"]}}}

# =======================================================
# КАРТА ИНСТРУМЕНТОВ ДЛЯ РОУТЕРА (Никаких нулей!)
# =======================================================
TOOL_REGISTRY = {
    ...
    "app_mng_route": [manage_windows_tool, execute_cmd_tool],
    "todo&note_route": [create_note_tool, get_time_tool],
    "timer_alarm": [set_timer_tool, get_time_tool],
    "code_assistant": [search_web_tavily_tool], # Для кода даем поиск в инете
    "calendar_route": [create_note_tool, get_time_tool], 
    "smarthome_control": [], # Пока заглушка, нет умного дома
    "assistant_config": [], # Заглушка
    "goodbye": [], # Инструменты не нужны
    "chat": [], # Инструменты не нужны
}